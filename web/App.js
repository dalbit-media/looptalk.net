...
import * as Sentry from "./src/utils/sentry.web";
...
const webAppPrefix = Platform.OS === "web" && typeof window !== "undefined"
...
const linking = {
  prefixes: ["looptalk://", "https://looptalk.app/app/", webAppPrefix].filter(Boolean),
